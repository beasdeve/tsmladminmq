<?php
  ...
  use App\Jobs\SubCategoryUpdate;
  use App\Jobs\SubCategoryInActive;
  use App\Jobs\SubCategoryActive;
  use App\Jobs\SubCategoryDelete;
  use App\Jobs\SubCateExcelInsert;
  use App\Jobs\SubCateExcelUpdate;
  use File; 
  use Storage;
  use Response;
  use DB; 
                       ...
                       if(!empty($product_id) && !empty($category_id)){
                        ...
                        $res = ProductSubCategory::where('sub_cat_name',trim($val[2]))
                         ...
                         {  
                            ...
                            $input['matcode'] = $val[12];
                            $input['d'] = $val[4];
                            $input['subcatid'] = $sub_cat->id;

                            SubCateExcelInsert::dispatch($input);
                            ...
                            $input['matcode'] = $val[12];
                            $input['d'] = $val[4];
                            $input['subcatid'] = $res->id;

                            SubCateExcelUpdate::dispatch($input);
                       }
        ...
        // dd($mt3);
            ...
            $chkcata = Category::where('id',$cataId)->first();
                ...
                if (!empty($chkcata)) {
                    ...
                    $purpose = 'Sub category created';

                    $res = (new AdminLogsService)->adminlogs($user,$sub,$purpose);

                    $input['rmatno'] = $request->mat;
                    $input['rprosize'] = $request->pro_size;
                    $input['subcatid'] = $subCategoryData->id;

                    SubcategoryCreated::dispatch($input);
        ...
        public function updateSubCategory(Request $request)
        {
            ...
            $chkcata = Category::where('id',$cataId)->first(); 
                ...
                if (!empty($chkcata)) {
                    ...
                    $updateSubCat['plant_code'] = $request->plant_code;
                    ...
                    $updateSubCat['rmatno'] = $request->mat;
                    $updateSubCat['rprosize'] = $request->pro_size;
                    $updateSubCat['subcatid'] = $request->sub_cat_id;

                    SubCategoryUpdate::dispatch($updateSubCat);
        ...
        */
        ...
        {  
            ...
            { 
                ...
                $user = Auth::user()->id;
                $sub = 'Sub Category inactive';
                $purpose = 'Sub category inactive';

                $res = (new AdminLogsService)->adminlogs($user,$sub,$purpose); 
 
                $input['subcatid'] =$subCategory->id;

                SubCategoryInActive::dispatch($input);
        ...
        {  
            ...
            { 
                ...
                $purpose = 'Sub category active';

                $res = (new AdminLogsService)->adminlogs($user,$sub,$purpose); 
 
                $input['subcatid'] =$subCategory->id;

                SubCategoryActive::dispatch($input);
        ...
        {  
          // dd($id);
            ...
            { 
                ...
                $purpose = 'Sub category delete';

                $res = (new AdminLogsService)->adminlogs($user,$sub,$purpose); 
 
                $input['subcatid'] =$subCategory->id;

                SubCategoryDelete::dispatch($input);
