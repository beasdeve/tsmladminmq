...
class StubbingController extends Controller
{
   public function gstDetailsDummy(Request $request)
    ...
    public function sapSalesContarct(Request $request)
    {
        ...
        curl_setopt_array($curl, array(
          ...
          CURLOPT_POSTFIELDS =>'{
                  ...
                  "SoldToParty": {
                    "QtyContractTSML": 100,
                    "Sold_To_Party": "50000170",
                    "Ship_To_Party": "50000170",
                  ...
                  "Items":
                    {
                      ...
                      "Material": "120000091",
                      "Quantity": 100,
                      "CustomarMaterialNumber": "120000091",
                      "OrderQuantity": "100",
                      "Plant": "3110",
                      "OverallStatus": "",
                      "StorageLocation": ""
    ...
    public function sapCusLedger(Request $request)
    {
        ...
        // dd(json_encode($request->authorizationData));
        $curl = curl_init();
        ...
        curl_setopt_array($curl, array(
          ...
          ,
          CURLOPT_HTTPHEADER => array(
            'Authorization: json_encode($request->authorizationData)',
            'Content-Type: application/json'
          ),
        ));
