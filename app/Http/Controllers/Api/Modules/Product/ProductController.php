...
use App\Jobs\ProductActive;
use App\Jobs\ProductInActive;
use JWTAuth;
use Validator;
use Response;
use File; 
...
class ProductController extends Controller
{
   ...
   public function storeProduct(Request $request)
   {
        ...
        $input['proId'] = $productData->id;
        // dd($input);
        ProductCreate::dispatch($input);
    ...
    public function updateProduct(Request $request)
    {
        ...
        $chkpro = Product::find($request->proId); 
            ...
            if (!empty($chkpro)) {
                ...
                $res = (new AdminLogsService)->adminlogs($user,$sub,$purpose);
                $input['proId'] = $chkpro->id;

                ProductUpdate::dispatch($input);
    ...
    */
    ...
    {  
        ...
        { 
            ...
            $user = Auth::user()->id; 
            $sub = 'Product active';
            $purpose = 'Product active';

            $res = (new AdminLogsService)->adminlogs($user,$sub,$purpose);
            $input['proId'] = $getProduct->id;
            
            ProductActive::dispatch($input);
    ...
    */
    ...
    {  
        ...
        { 
            ...
            $user = Auth::user()->id; 
            $sub = 'Product Inactive';
            $purpose = 'Product inactive';

            $res = (new AdminLogsService)->adminlogs($user,$sub,$purpose);
            $input['proId'] = $getProduct->id;
            
            ProductInActive::dispatch($input);
